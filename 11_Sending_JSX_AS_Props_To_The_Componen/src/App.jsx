    ...
    return (
        <div className="layout">
            ...
            <div className="main-content">
                <div className="posts">
                    <Post title="Post 1" description={descriptionPost} color="red">
                    ...
                    <Post title="Post 4" description="This is a description of Post 4." color="blue" />
                    <Post title="Post 5" description="This is a description of Post 5." color="greenyellow" />
                </div>
